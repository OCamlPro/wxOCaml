...
value wxWindow_SetLabel_c(value self_v, value _title_v)
{
  value ret_v;
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  wxString _title_cc = wxString( String_val(_title_v), wxConvUTF8 );
   wxString* _title_c = &_title_cc;
  self_c->SetLabel(*_title_c);
  ret_v = Val_unit;
  return ret_v;
}
...
value wxWindow_SetName_c(value self_v, value _name_v)
{
  value ret_v;
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  wxString _name_cc = wxString( String_val(_name_v), wxConvUTF8 );
   wxString* _name_c = &_name_cc;
  self_c->SetName(*_name_c);
  ret_v = Val_unit;
  return ret_v;
}
...
value wxWindow_GetWindowStyleFlag_c(value self_v)
{
  ...
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  int *ret_c = new int();
  *ret_c = self_c->GetWindowStyleFlag();
  ret_v = Val_abstract( ret_c );
  return ret_v;
}
...
value wxWindow_FindWindow_c(value self_v, value name_v)
{
  value ret_v;
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  wxString name_cc = wxString( String_val(name_v), wxConvUTF8 );
   wxString* name_c = &name_cc;
  wxWindow * ret_c = self_c->FindWindow(*name_c);
  ret_v = Val_abstractOption( ret_c );
  return ret_v;
}
...
value wxWindow_TransferDataToWindow_c(value self_v)
{
  ...
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  bool *ret_c = new bool();
  *ret_c = self_c->TransferDataToWindow();
  ret_v = Val_bool(ret_c);
  return ret_v;
}
...
value wxWindow_TransferDataFromWindow_c(value self_v)
{
  ...
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  bool *ret_c = new bool();
  *ret_c = self_c->TransferDataFromWindow();
  ret_v = Val_bool(ret_c);
  return ret_v;
}
...
value wxWindow_ConvertPixelsToDialog_c(value self_v, value pt_v)
{
  value ret_v;
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  wxPoint pt_cc = WxPoint_val(pt_v);
  wxPoint* pt_c = &pt_cc;
...
value wxWindow_IsExposed_c(value self_v, value x_v, value y_v, value w_v, value h_v)
{
  ...
  int h_c = Int_val(h_v);
  bool *ret_c = new bool();
  *ret_c = self_c->IsExposed(x_c, y_c, w_c, h_c);
  ret_v = Val_bool(ret_c);
  return ret_v;
}
...
value wxWindow_SetBackgroundColour_c(value self_v, value colour_v)
{
  ...
  bool *ret_c = new bool();
  *ret_c = self_c->SetBackgroundColour(*colour_c);
  ret_v = Val_bool(ret_c);
  return ret_v;
}
...
value wxWindow_ScreenToClient_c(value self_v, value pos_v)
{
  value ret_v;
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  wxPoint pos_cc = WxPoint_val(pos_v);
  wxPoint* pos_c = &pos_cc;
...
value wxWindow_PopupMenu_c(value self_v, value menu_v, value x_v, value y_v)
{
  ...
  int y_c = Int_val(y_v);
  bool *ret_c = new bool();
  *ret_c = self_c->PopupMenu(menu_c, x_c, y_c);
  ret_v = Val_bool(ret_c);
  return ret_v;
}
...
value wxWindow_GetScrollPos_c(value self_v, value orient_v)
{
  ...
  int orient_c = Int_val(orient_v);
  int *ret_c = new int();
  *ret_c = self_c->GetScrollPos(orient_c);
  ret_v = Val_abstract( ret_c );
  return ret_v;
}
...
value wxWindow_GetScrollThumb_c(value self_v, value orient_v)
{
  ...
  int orient_c = Int_val(orient_v);
  int *ret_c = new int();
  *ret_c = self_c->GetScrollThumb(orient_c);
  ret_v = Val_abstract( ret_c );
  return ret_v;
}
...
value wxWindow_GetScrollRange_c(value self_v, value orient_v)
{
  ...
  int orient_c = Int_val(orient_v);
  int *ret_c = new int();
  *ret_c = self_c->GetScrollRange(orient_c);
  ret_v = Val_abstract( ret_c );
  return ret_v;
}
...
value wxWindow_SetToolTip_c(value self_v, value tip_v)
{
  value ret_v;
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  wxString tip_cc = wxString( String_val(tip_v), wxConvUTF8 );
   wxString* tip_c = &tip_cc;
  self_c->SetToolTip(*tip_c);
  ret_v = Val_unit;
  return ret_v;
}
...
value wxWindow_GetConstraintsInvolvedIn_c(value self_v)
{
  value ret_v;
  wxWindow* self_c = (wxWindow*)Abstract_val(self_v);
  wxWindowList * ret_c = self_c->GetConstraintsInvolvedIn();
  ret_v = Val_abstractOption( ret_c );
  return ret_v;
}
