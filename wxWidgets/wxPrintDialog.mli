...
external getPrintDialogData : wxPrintDialog -> wxPrintDialogData
	= "camlidl_wxc_idl_wxPrintDialog_GetPrintDialogData"

external getPrintData : wxPrintDialog -> wxPrintData -> unit
	= "camlidl_wxc_idl_wxPrintDialog_GetPrintData"

external getPrintDC : wxPrintDialog -> wxDC
	= "camlidl_wxc_idl_wxPrintDialog_GetPrintDC"
...
val setToolTip : wxPrintDialog -> string -> unit
val setName : wxPrintDialog -> string -> unit
val setLabel : wxPrintDialog -> string -> unit
val getToolTip : wxPrintDialog -> string
val getTextExtent : wxPrintDialog -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxPrintDialog -> string
val getLabel : wxPrintDialog -> string
val findWindow : wxPrintDialog -> string -> wxWindow
  val ptrNULL : wxPrintDialog
