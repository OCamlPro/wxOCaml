...
val getMultiLineTextExtent : wxPrinterDC -> string -> voidptr -> voidptr -> voidptr -> wxFont -> unit
val drawText : wxPrinterDC -> string -> int -> int -> unit
val drawRotatedText : wxPrinterDC -> string -> int -> int -> float -> unit
val drawLabelBitmap : wxPrinterDC -> string -> wxBitmap -> int -> int -> int -> int -> int -> int -> wxRect
val drawLabel : wxPrinterDC -> string -> int -> int -> int -> int -> int -> int -> unit
  val ptrNULL : wxPrinterDC
