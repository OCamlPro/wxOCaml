...
value wxArtProvider_HasNativeProvider_c()
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxArtProvider_HasNativeProvider_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxArtProvider_GetNativeSizeHint_c(value client_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxArtProvider_GetNativeSizeHint_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxArtProvider_GetIconBundle_c(value id_v, value client_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxArtProvider_GetIconBundle_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
