...
external connect : wxControl -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
val setToolTip : wxControl -> string -> unit
val setName : wxControl -> string -> unit
val setLabel : wxControl -> string -> unit
val getToolTip : wxControl -> string
val getTextExtent : wxControl -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxControl -> string
val getLabel : wxControl -> string
val findWindow : wxControl -> string -> wxWindow
  val ptrNULL : wxControl
