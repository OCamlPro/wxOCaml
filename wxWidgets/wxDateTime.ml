...
let getWeekDayName weekday flags =
  let wxres = getWeekDayName weekday flags  in
  WxString.getUtf8 wxres

let getPmString () =
  let wxres = getPmString ()  in
  WxString.getUtf8 wxres

let getMonthName month flags =
  let wxres = getMonthName month flags  in
  WxString.getUtf8 wxres

let getAmString () =
  let wxres = getAmString ()  in
  WxString.getUtf8 wxres

let formatTime _obj =
  let wxres = formatTime _obj  in
  WxString.getUtf8 wxres

let formatISOTime _obj =
  let wxres = formatISOTime _obj  in
  WxString.getUtf8 wxres

let formatISODate _obj =
  let wxres = formatISODate _obj  in
  WxString.getUtf8 wxres

let formatDate _obj =
  let wxres = formatDate _obj  in
  WxString.getUtf8 wxres

let format _obj _format tz =
  let wxres = format _obj _format tz  in
  WxString.getUtf8 wxres
