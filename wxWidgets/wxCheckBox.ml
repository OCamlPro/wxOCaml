...
external setValue : wxCheckBox -> int -> unit
	= "camlidl_wxc_idl_wxCheckBox_SetValue"
...
external getValue : wxCheckBox -> bool
	= "camlidl_wxc_idl_wxCheckBox_GetValue"
...
external delete : wxCheckBox -> unit
	= "camlidl_wxc_idl_wxCheckBox_Delete"
...
external connect : wxCheckBox -> int -> int -> (wxEvent -> unit) -> unit
...
external null_object : unit -> wxCheckBox
