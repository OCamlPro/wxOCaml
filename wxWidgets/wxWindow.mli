...
external connect : wxWindow -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
val setToolTip : wxWindow -> string -> unit
val setName : wxWindow -> string -> unit
val setLabel : wxWindow -> string -> unit
val getToolTip : wxWindow -> string
val getTextExtent : wxWindow -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxWindow -> string
val getLabel : wxWindow -> string
val findWindow : wxWindow -> string -> wxWindow
  val ptrNULL : wxWindow
