...
external setRow : wxGridEditorCreatedEvent -> int -> unit
	= "camlidl_wxc_idl_wxGridEditorCreatedEvent_SetRow"
...
external setControl : wxGridEditorCreatedEvent -> wxControl -> unit
	= "camlidl_wxc_idl_wxGridEditorCreatedEvent_SetControl"

external setCol : wxGridEditorCreatedEvent -> int -> unit
	= "camlidl_wxc_idl_wxGridEditorCreatedEvent_SetCol"
...
external getRow : wxGridEditorCreatedEvent -> int
	= "camlidl_wxc_idl_wxGridEditorCreatedEvent_GetRow"
...
external getControl : wxGridEditorCreatedEvent -> wxControl
	= "camlidl_wxc_idl_wxGridEditorCreatedEvent_GetControl"

external getCol : wxGridEditorCreatedEvent -> int
	= "camlidl_wxc_idl_wxGridEditorCreatedEvent_GetCol"
...
val setString : wxGridEditorCreatedEvent -> string -> unit
val getString : wxGridEditorCreatedEvent -> string
  val ptrNULL : wxGridEditorCreatedEvent
