...
val wxnew : wxWindow -> int -> string -> int -> int -> int -> int -> int -> wxStyledTextCtrl
val userListShow : wxStyledTextCtrl -> int -> string -> unit
val textWidth : wxStyledTextCtrl -> int -> string -> int
val styleSetSpec : wxStyledTextCtrl -> int -> string -> unit
val styleSetFontAttr : wxStyledTextCtrl -> int -> int -> string -> bool -> bool -> bool -> unit
val styleSetFaceName : wxStyledTextCtrl -> int -> string -> unit
val setWordChars : wxStyledTextCtrl -> string -> unit
val setToolTip : wxStyledTextCtrl -> string -> unit
val setText : wxStyledTextCtrl -> string -> unit
val setProperty : wxStyledTextCtrl -> string -> string -> unit
val setName : wxStyledTextCtrl -> string -> unit
val setLexerLanguage : wxStyledTextCtrl -> string -> unit
val setLabel : wxStyledTextCtrl -> string -> unit
val setKeyWords : wxStyledTextCtrl -> int -> string -> unit
val searchPrev : wxStyledTextCtrl -> int -> string -> int
val searchNext : wxStyledTextCtrl -> int -> string -> int
val searchInTarget : wxStyledTextCtrl -> string -> int
val saveFile : wxStyledTextCtrl -> string -> bool
val replaceTargetRE : wxStyledTextCtrl -> string -> int
val replaceTarget : wxStyledTextCtrl -> string -> int
val replaceSelection : wxStyledTextCtrl -> string -> unit
val loadFile : wxStyledTextCtrl -> string -> bool
val insertText : wxStyledTextCtrl -> int -> string -> unit
val getToolTip : wxStyledTextCtrl -> string
val getTextRange : wxStyledTextCtrl -> int -> int -> string
val getTextExtent : wxStyledTextCtrl -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getText : wxStyledTextCtrl -> string
val getSelectedText : wxStyledTextCtrl -> string
val getName : wxStyledTextCtrl -> string
val getLine : wxStyledTextCtrl -> int -> string
val getLabel : wxStyledTextCtrl -> string
val findWindow : wxStyledTextCtrl -> string -> wxWindow
val findText : wxStyledTextCtrl -> int -> int -> string -> int -> int
val copyText : wxStyledTextCtrl -> int -> string -> unit
val callTipShow : wxStyledTextCtrl -> int -> string -> unit
val autoCompStops : wxStyledTextCtrl -> string -> unit
val autoCompShow : wxStyledTextCtrl -> int -> string -> unit
val autoCompSetFillUps : wxStyledTextCtrl -> string -> unit
val autoCompSelect : wxStyledTextCtrl -> string -> unit
val appendText : wxStyledTextCtrl -> string -> unit
val addText : wxStyledTextCtrl -> string -> unit
  val ptrNULL : wxStyledTextCtrl
