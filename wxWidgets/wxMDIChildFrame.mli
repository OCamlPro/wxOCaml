...
external connect : wxMDIChildFrame -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
val wxnew : wxWindow -> int -> string -> int -> int -> int -> int -> int -> wxMDIChildFrame
val setToolTip : wxMDIChildFrame -> string -> unit
val setTitle : wxMDIChildFrame -> string -> unit
val setStatusText : wxMDIChildFrame -> string -> int -> unit
val setName : wxMDIChildFrame -> string -> unit
val setLabel : wxMDIChildFrame -> string -> unit
val getToolTip : wxMDIChildFrame -> string
val getTitle : wxMDIChildFrame -> string
val getTextExtent : wxMDIChildFrame -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxMDIChildFrame -> string
val getLabel : wxMDIChildFrame -> string
val findWindow : wxMDIChildFrame -> string -> wxWindow
  val ptrNULL : wxMDIChildFrame
