...
external connect : wxTextEntryDialog -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
val setToolTip : wxTextEntryDialog -> string -> unit
val setName : wxTextEntryDialog -> string -> unit
val setLabel : wxTextEntryDialog -> string -> unit
val getToolTip : wxTextEntryDialog -> string
val getTextExtent : wxTextEntryDialog -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxTextEntryDialog -> string
val getLabel : wxTextEntryDialog -> string
val findWindow : wxTextEntryDialog -> string -> wxWindow
  val ptrNULL : wxTextEntryDialog
