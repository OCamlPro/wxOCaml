...
external showModal : wxMessageDialog -> int
	= "camlidl_wxc_idl_wxMessageDialog_ShowModal"
...
external delete : wxMessageDialog -> unit
	= "camlidl_wxc_idl_wxMessageDialog_Delete"
...
val wxnew : wxWindow -> string -> string -> int -> wxMessageDialog
val setToolTip : wxMessageDialog -> string -> unit
val setName : wxMessageDialog -> string -> unit
val setLabel : wxMessageDialog -> string -> unit
val getToolTip : wxMessageDialog -> string
val getTextExtent : wxMessageDialog -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxMessageDialog -> string
val getLabel : wxMessageDialog -> string
val findWindow : wxMessageDialog -> string -> wxWindow
  val ptrNULL : wxMessageDialog
