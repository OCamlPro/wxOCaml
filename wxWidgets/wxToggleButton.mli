...
val setToolTip : wxToggleButton -> string -> unit
val setName : wxToggleButton -> string -> unit
val setLabel : wxToggleButton -> string -> unit
val getToolTip : wxToggleButton -> string
val getTextExtent : wxToggleButton -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxToggleButton -> string
val getLabel : wxToggleButton -> string
val findWindow : wxToggleButton -> string -> wxWindow
  val ptrNULL : wxToggleButton
