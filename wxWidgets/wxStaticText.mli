...
external connect : wxStaticText -> int -> int -> (wxEvent -> unit) -> unit
...
val wxnew : wxWindow -> int -> string -> int -> int -> int -> int -> int -> wxStaticText
val setToolTip : wxStaticText -> string -> unit
val setName : wxStaticText -> string -> unit
val setLabel : wxStaticText -> string -> unit
val getToolTip : wxStaticText -> string
val getTextExtent : wxStaticText -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxStaticText -> string
val getLabel : wxStaticText -> string
val findWindow : wxStaticText -> string -> wxWindow
  val ptrNULL : wxStaticText
