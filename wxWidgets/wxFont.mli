...
external delete : wxFont -> unit
	= "camlidl_wxc_wxFont_Delete"

external createFromStock : int -> wxFont
	= "camlidl_wxc_wxFont_CreateFromStock"

external createDefault : unit -> wxFont
	= "camlidl_wxc_wxFont_CreateDefault"
