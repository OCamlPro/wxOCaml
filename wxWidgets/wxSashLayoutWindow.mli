...
external setOrientation : wxSashLayoutWindow -> int -> unit
	= "camlidl_wxc_idl_wxSashLayoutWindow_SetOrientation"
...
external setDefaultSize : wxSashLayoutWindow -> int -> int -> unit
	= "camlidl_wxc_idl_wxSashLayoutWindow_SetDefaultSize"
...
external setAlignment : wxSashLayoutWindow -> int -> unit
	= "camlidl_wxc_idl_wxSashLayoutWindow_SetAlignment"
...
external getOrientation : wxSashLayoutWindow -> int
	= "camlidl_wxc_idl_wxSashLayoutWindow_GetOrientation"
...
external getAlignment : wxSashLayoutWindow -> int
	= "camlidl_wxc_idl_wxSashLayoutWindow_GetAlignment"
...
external connect : wxSashLayoutWindow -> int -> int -> (wxEvent -> unit) -> unit
...
val setToolTip : wxSashLayoutWindow -> string -> unit
val setName : wxSashLayoutWindow -> string -> unit
val setLabel : wxSashLayoutWindow -> string -> unit
val getToolTip : wxSashLayoutWindow -> string
val getTextExtent : wxSashLayoutWindow -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxSashLayoutWindow -> string
val getLabel : wxSashLayoutWindow -> string
val findWindow : wxSashLayoutWindow -> string -> wxWindow
  val ptrNULL : wxSashLayoutWindow
