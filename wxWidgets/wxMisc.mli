...
val wxClassInfo_GetClassNameEx : wxClassInfo -> string
val wxClassInfo_GetBaseClassName2 : wxClassInfo -> string
val wxClassInfo_GetBaseClassName1 : wxClassInfo -> string
val wxClassInfo_FindClass : string -> wxClassInfo
val wxTextOutputStream_WriteString : wxTextOutputStream -> string -> unit
val wxTextInputStream_ReadLine : wxTextInputStream -> string
val wxTextInputStream_Create : wxInputStream -> string -> wxTextInputStream
...
val wxSingleInstanceChecker_Create : voidptr -> string -> string -> bool
val wxMimeTypesManager_IsOfType : wxMimeTypesManager -> string -> string -> bool
val wxMimeTypesManager_GetFileTypeFromMimeType : wxMimeTypesManager -> string -> wxFileType
val wxMimeTypesManager_GetFileTypeFromExtension : wxMimeTypesManager -> string -> wxFileType
val wxIconBundle_CreateFromFile : string -> int -> wxIconBundle
val wxIconBundle_AddIconFromFile : wxIconBundle -> string -> int -> unit
val wxFontMapper_IsEncodingAvailable : wxFontMapper -> int -> string -> bool
val wxFontMapper_GetAltForEncoding : wxFontMapper -> int -> voidptr -> string -> bool
val wxFontEnumerator_EnumerateEncodings : wxFontEnumerator -> string -> bool
val wxFileType_GetMimeType : wxFileType -> string
val wxFileType_GetDescription : wxFileType -> string
val wxFileType_ExpandCommand : wxFileType -> voidptr -> voidptr -> string
val fileDataObject_AddFile : wxFileDataObject -> string -> unit
val wxDateTime_GetWeekDayName : int -> int -> string
val wxDateTime_GetPmString : unit -> string
val wxDateTime_GetMonthName : int -> int -> string
val wxDateTime_GetAmString : unit -> string
val wxDateTime_FormatTime : wxDateTime -> string
val wxDateTime_FormatISOTime : wxDateTime -> string
val wxDateTime_FormatISODate : wxDateTime -> string
val wxDateTime_FormatDate : wxDateTime -> string
val wxDateTime_Format : wxDateTime -> voidptr -> int -> string
val wxDataFormat_GetId : wxDataFormat -> string
val wxDataFormat_CreateFromId : string -> wxDataFormat
val cursor_CreateLoad : string -> int -> int -> int -> wxCursor
val wxClassInfo_IsKindOf : wxClassInfo -> string -> bool
val wxBusyInfo_Create : string -> wxBusyInfo
val eLJDragDataObject_Create : voidptr -> string -> voidptr -> voidptr -> voidptr -> eLJDragDataObject
