...
external connect : wxTreeCtrl -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
val setToolTip : wxTreeCtrl -> string -> unit
val setName : wxTreeCtrl -> string -> unit
val setLabel : wxTreeCtrl -> string -> unit
val setItemText : wxTreeCtrl -> wxTreeItemId -> string -> unit
val prependItem : wxTreeCtrl -> wxTreeItemId -> string -> int -> int -> voidptr -> wxTreeItemId -> unit
val insertItemByIndex2 : wxTreeCtrl -> wxWindow -> int -> string -> int -> int -> wxClosure -> wxTreeItemId -> unit
val insertItemByIndex : wxTreeCtrl -> wxTreeItemId -> int -> string -> int -> int -> voidptr -> wxTreeItemId -> unit
val insertItem2 : wxTreeCtrl -> wxWindow -> wxTreeItemId -> string -> int -> int -> wxClosure -> wxTreeItemId -> unit
val insertItem : wxTreeCtrl -> wxTreeItemId -> wxTreeItemId -> string -> int -> int -> voidptr -> wxTreeItemId -> unit
val getToolTip : wxTreeCtrl -> string
val getTextExtent : wxTreeCtrl -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxTreeCtrl -> string
val getLabel : wxTreeCtrl -> string
val getItemText : wxTreeCtrl -> wxTreeItemId -> string
val findWindow : wxTreeCtrl -> string -> wxWindow
val appendItem : wxTreeCtrl -> wxTreeItemId -> string -> int -> int -> wxTreeItemData -> wxTreeItemId -> unit
val addRoot : wxTreeCtrl -> string -> int -> int -> wxTreeItemData -> wxTreeItemId -> unit
  val ptrNULL : wxTreeCtrl
