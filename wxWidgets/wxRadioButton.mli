...
val wxnew : wxWindow -> int -> string -> int -> int -> int -> int -> int -> wxRadioButton
val setToolTip : wxRadioButton -> string -> unit
val setName : wxRadioButton -> string -> unit
val setLabel : wxRadioButton -> string -> unit
val getToolTip : wxRadioButton -> string
val getTextExtent : wxRadioButton -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxRadioButton -> string
val getLabel : wxRadioButton -> string
val findWindow : wxRadioButton -> string -> wxWindow
  val ptrNULL : wxRadioButton
