...
void camlidl_ml2c_wxc_idl_wxMDIParentFrame(value _v1, wxMDIParentFrame * _c2, camlidl_ctx _ctx)
{
  *_c2 = *((wxMDIParentFrame *) Bp_val(_v1));
}

value camlidl_c2ml_wxc_idl_wxMDIParentFrame(wxMDIParentFrame * _c2, camlidl_ctx _ctx)
{
value _v1;
...
value camlidl_wxc_idl_wxMDIParentFrame_ActivateNext(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_wxc_idl_wxMDIParentFrame(_v__obj, &_obj, _ctx);
  wxMDIParentFrame_ActivateNext(_obj);
  camlidl_free(_ctx);
  return Val_unit;
}

value camlidl_wxc_idl_wxMDIParentFrame_ActivatePrevious(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
...
value camlidl_wxc_idl_wxMDIParentFrame_ArrangeIcons(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
...
value camlidl_wxc_idl_wxMDIParentFrame_Cascade(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
...
value camlidl_wxc_idl_wxMDIParentFrame_Create(
	value _v__prt,
	value _v__id,
	value _v__txt,
	value _v__lft,
...
value camlidl_wxc_idl_wxMDIParentFrame_Create_bytecode(value * argv, int argn)
{
  return camlidl_wxc_idl_wxMDIParentFrame_Create(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7]);
}

value camlidl_wxc_idl_wxMDIParentFrame_GetActiveChild(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
...
value camlidl_wxc_idl_wxMDIParentFrame_GetClientWindow(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
  ...
  _vres = camlidl_c2ml_wxc_idl_wxMDIClientWindow(&_res, _ctx);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_wxc_idl_wxMDIParentFrame_GetWindowMenu(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
  wxMenu _res;
...
value camlidl_wxc_idl_wxMDIParentFrame_OnCreateClient(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
  wxMDIClientWindow _res;
...
value camlidl_wxc_idl_wxMDIParentFrame_SetWindowMenu(
	value _v__obj,
	value _v_menu)
{
  wxMDIParentFrame _obj; /*in*/
...
value camlidl_wxc_idl_wxMDIParentFrame_Tile(
	value _v__obj)
{
  wxMDIParentFrame _obj; /*in*/
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
