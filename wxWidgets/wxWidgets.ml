...
let wxTextInputStream inputStream sep =
  let sep = WxString.createUTF8 sep in
  let wxres = wxTextInputStream inputStream sep  in
  WxString.delete sep;
  wxres
...
let wxFileProperty label name _value =
  let label = WxString.createUTF8 label in
  let name = WxString.createUTF8 name in
  let _value = WxString.createUTF8 _value in
  let wxres = wxFileProperty label name _value  in
  WxString.delete label;
  WxString.delete name;
...
let wxDateProperty label name _value =
  let label = WxString.createUTF8 label in
  let name = WxString.createUTF8 name in
  let wxres = wxDateProperty label name _value  in
  WxString.delete label;
  WxString.delete name;
  wxres
...
let wxFloatProperty label name _value =
  let label = WxString.createUTF8 label in
  let name = WxString.createUTF8 name in
  let wxres = wxFloatProperty label name _value  in
  WxString.delete label;
  WxString.delete name;
  wxres
...
let wxBoolProperty label name _value =
  let label = WxString.createUTF8 label in
  let name = WxString.createUTF8 name in
  let wxres = wxBoolProperty label name _value  in
  WxString.delete label;
  WxString.delete name;
  wxres
...
let wxIntProperty label name _value =
  let label = WxString.createUTF8 label in
  let name = WxString.createUTF8 name in
  let wxres = wxIntProperty label name _value  in
  WxString.delete label;
  WxString.delete name;
  wxres
...
let wxStringProperty label name _value =
  let label = WxString.createUTF8 label in
  let name = WxString.createUTF8 name in
  let _value = WxString.createUTF8 _value in
  let wxres = wxStringProperty label name _value  in
  WxString.delete label;
  WxString.delete name;
  WxString.delete _value;
  wxres
...
let wxSingleInstanceChecker _obj name path =
  let name = WxString.createUTF8 name in
  let path = WxString.createUTF8 path in
  let wxres = wxSingleInstanceChecker _obj name path  in
  WxString.delete name;
...
let eLJDragDataObject _obj _fmt _func1 _func2 _func3 =
  let _fmt = WxString.createUTF8 _fmt in
  let wxres = eLJDragDataObject _obj _fmt _func1 _func2 _func3  in
...
external ignore_wxChildFocusEvent : wxChildFocusEvent -> unit = "%ignore"
...
external ignore_wxClipboardTextEvent : wxClipboardTextEvent -> unit = "%ignore"
external ignore_wxCloseEvent : wxCloseEvent -> unit = "%ignore"
external ignore_wxClosure : wxClosure -> unit = "%ignore"
external ignore_wxCollapsiblePaneEvent : wxCollapsiblePaneEvent -> unit = "%ignore"
...
external ignore_wxColourPickerEvent : wxColourPickerEvent -> unit = "%ignore"
...
external ignore_wxContextMenuEvent : wxContextMenuEvent -> unit = "%ignore"
...
external ignore_wxDataViewEvent : wxDataViewEvent -> unit = "%ignore"
...
external ignore_wxFileCtrlEvent : wxFileCtrlEvent -> unit = "%ignore"
external ignore_wxFileDataObject : wxFileDataObject -> unit = "%ignore"
external ignore_wxFileDialog : wxFileDialog -> unit = "%ignore"
external ignore_wxFileDirPickerEvent : wxFileDirPickerEvent -> unit = "%ignore"
...
external ignore_wxFontPickerEvent : wxFontPickerEvent -> unit = "%ignore"
...
external ignore_wxHyperlinkEvent : wxHyperlinkEvent -> unit = "%ignore"
...
external ignore_wxMouseCaptureLostEvent : wxMouseCaptureLostEvent -> unit = "%ignore"
...
external ignore_wxPowerEvent : wxPowerEvent -> unit = "%ignore"
...
external ignore_wxSpinDoubleEvent : wxSpinDoubleEvent -> unit = "%ignore"
...
external ignore_wxTreeListEvent : wxTreeListEvent -> unit = "%ignore"
