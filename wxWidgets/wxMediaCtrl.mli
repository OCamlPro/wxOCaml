...
external tell : wxMediaCtrl -> int64
	= "camlidl_wxc_idl_wxMediaCtrl_Tell"

external stop : wxMediaCtrl -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_Stop"

external showPlayerControls : wxMediaCtrl -> int -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_ShowPlayerControls"
...
external setVolume : wxMediaCtrl -> float -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_SetVolume"
...
external setPlaybackRate : wxMediaCtrl -> float -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_SetPlaybackRate"
...
external seek : wxMediaCtrl -> int64 -> int -> int64
	= "camlidl_wxc_idl_wxMediaCtrl_Seek"
...
external play : wxMediaCtrl -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_Play"

external pause : wxMediaCtrl -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_Pause"
...
external loadURIWithProxy : wxMediaCtrl -> wxString -> wxString -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_LoadURIWithProxy"

external loadURI : wxMediaCtrl -> wxString -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_LoadURI"

external load : wxMediaCtrl -> wxString -> bool
	= "camlidl_wxc_idl_wxMediaCtrl_Load"

external length : wxMediaCtrl -> int64
	= "camlidl_wxc_idl_wxMediaCtrl_Length"
...
external getVolume : wxMediaCtrl -> float
	= "camlidl_wxc_idl_wxMediaCtrl_GetVolume"
...
external getState : wxMediaCtrl -> int
	= "camlidl_wxc_idl_wxMediaCtrl_GetState"
...
external getPlaybackRate : wxMediaCtrl -> float
	= "camlidl_wxc_idl_wxMediaCtrl_GetPlaybackRate"
...
external getBestSize : wxMediaCtrl -> wxSize
	= "camlidl_wxc_idl_wxMediaCtrl_GetBestSize"
...
external delete : wxMediaCtrl -> unit
	= "camlidl_wxc_idl_wxMediaCtrl_Delete"
...
val wxnew : wxWindow -> int -> string -> int -> int -> int -> int -> int -> string -> string -> wxMediaCtrl
val setToolTip : wxMediaCtrl -> string -> unit
val setName : wxMediaCtrl -> string -> unit
val setLabel : wxMediaCtrl -> string -> unit
val loadURIWithProxy : wxMediaCtrl -> string -> string -> bool
val loadURI : wxMediaCtrl -> string -> bool
val load : wxMediaCtrl -> string -> bool
val getToolTip : wxMediaCtrl -> string
val getTextExtent : wxMediaCtrl -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxMediaCtrl -> string
val getLabel : wxMediaCtrl -> string
val findWindow : wxMediaCtrl -> string -> wxWindow
  val ptrNULL : wxMediaCtrl
