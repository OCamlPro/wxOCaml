...
external connect : wxColourDialog -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
val setToolTip : wxColourDialog -> string -> unit
val setName : wxColourDialog -> string -> unit
val setLabel : wxColourDialog -> string -> unit
val getToolTip : wxColourDialog -> string
val getTextExtent : wxColourDialog -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxColourDialog -> string
val getLabel : wxColourDialog -> string
val findWindow : wxColourDialog -> string -> wxWindow
  val ptrNULL : wxColourDialog
