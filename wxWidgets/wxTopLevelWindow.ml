...
external setTitle : wxTopLevelWindow -> wxString -> unit
	= "camlidl_wxc_wxTopLevelWindow_SetTitle"
...
external getTitle : wxTopLevelWindow -> wxString
	= "camlidl_wxc_wxTopLevelWindow_GetTitle"
...
external connect : wxTopLevelWindow -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
let setTitle _obj pString =
  let pString = WxString.createUTF8 pString in
  let wxres = setTitle _obj pString  in
  WxString.delete pString;
  wxres
...
external null_object : unit -> wxTopLevelWindow
