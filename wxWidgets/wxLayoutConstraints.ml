...
external width : wxLayoutConstraints -> voidptr
	= "camlidl_wxc_wxLayoutConstraints_width"

external top : wxLayoutConstraints -> voidptr
	= "camlidl_wxc_wxLayoutConstraints_top"
...
external right : wxLayoutConstraints -> voidptr
	= "camlidl_wxc_wxLayoutConstraints_right"

external left : wxLayoutConstraints -> voidptr
	= "camlidl_wxc_wxLayoutConstraints_left"
...
external height : wxLayoutConstraints -> voidptr
	= "camlidl_wxc_wxLayoutConstraints_height"
...
external centreY : wxLayoutConstraints -> voidptr
	= "camlidl_wxc_wxLayoutConstraints_centreY"

external centreX : wxLayoutConstraints -> voidptr
	= "camlidl_wxc_wxLayoutConstraints_centreX"

external bottom : wxLayoutConstraints -> voidptr
	= "camlidl_wxc_wxLayoutConstraints_bottom"

external null_object : unit -> wxLayoutConstraints
