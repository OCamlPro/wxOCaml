...
external setStyle : wxDirDialog -> int -> unit
	= "camlidl_wxc_idl_wxDirDialog_SetStyle"
...
external setPath : wxDirDialog -> wxString -> unit
	= "camlidl_wxc_idl_wxDirDialog_SetPath"
...
external setMessage : wxDirDialog -> wxString -> unit
	= "camlidl_wxc_idl_wxDirDialog_SetMessage"
...
external getStyle : wxDirDialog -> int
	= "camlidl_wxc_idl_wxDirDialog_GetStyle"
...
external getPath : wxDirDialog -> wxString
	= "camlidl_wxc_idl_wxDirDialog_GetPath"
...
external getMessage : wxDirDialog -> wxString
	= "camlidl_wxc_idl_wxDirDialog_GetMessage"
...
val wxnew : wxWindow -> string -> string -> int -> int -> int -> wxDirDialog
val setToolTip : wxDirDialog -> string -> unit
val setPath : wxDirDialog -> string -> unit
val setName : wxDirDialog -> string -> unit
val setMessage : wxDirDialog -> string -> unit
val setLabel : wxDirDialog -> string -> unit
val getToolTip : wxDirDialog -> string
val getTextExtent : wxDirDialog -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getPath : wxDirDialog -> string
val getName : wxDirDialog -> string
val getMessage : wxDirDialog -> string
val getLabel : wxDirDialog -> string
val findWindow : wxDirDialog -> string -> wxWindow
  val ptrNULL : wxDirDialog
