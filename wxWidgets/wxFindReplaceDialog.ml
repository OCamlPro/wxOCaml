...
external setData : wxFindReplaceDialog -> wxFindReplaceData -> unit
	= "camlidl_wxc_wxFindReplaceDialog_SetData"
...
external getData : wxFindReplaceDialog -> wxFindReplaceData
	= "camlidl_wxc_wxFindReplaceDialog_GetData"
...
let wxnew parent data title style =
  let title = WxString.createUTF8 title in
  let wxres = wxnew parent data title style  in
...
external null_object : unit -> wxFindReplaceDialog
