...
void camlidl_ml2c_wxc_idl_wxImageList(value _v1, wxImageList * _c2, camlidl_ctx _ctx)
{
  *_c2 = *((wxImageList *) Bp_val(_v1));
}

value camlidl_c2ml_wxc_idl_wxImageList(wxImageList * _c2, camlidl_ctx _ctx)
{
value _v1;
...
value camlidl_wxc_idl_wxImageList_AddBitmap(
	value _v__obj,
	value _v_bitmap,
	value _v_mask)
{
  ...
  camlidl_ml2c_wxc_idl_wxImageList(_v__obj, &_obj, _ctx);
  camlidl_ml2c_wxc_idl_wxBitmap(_v_bitmap, &bitmap, _ctx);
  camlidl_ml2c_wxc_idl_wxBitmap(_v_mask, &mask, _ctx);
...
value camlidl_wxc_idl_wxImageList_AddIcon(
	value _v__obj,
	value _v_icon)
{
  wxImageList _obj; /*in*/
...
value camlidl_wxc_idl_wxImageList_AddMasked(
	value _v__obj,
	value _v_bitmap,
	value _v_maskColour)
{
  ...
  camlidl_ml2c_wxc_idl_wxImageList(_v__obj, &_obj, _ctx);
  camlidl_ml2c_wxc_idl_wxBitmap(_v_bitmap, &bitmap, _ctx);
  camlidl_ml2c_wxc_idl_wxColour(_v_maskColour, &maskColour, _ctx);
...
value camlidl_wxc_idl_wxImageList_Create(
	value _v_width,
	value _v_height,
	value _v_mask,
...
value camlidl_wxc_idl_wxImageList_Delete(
	value _v__obj)
{
  wxImageList _obj; /*in*/
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
...
value camlidl_wxc_idl_wxImageList_Draw(
	value _v__obj,
	value _v_index,
	value _v_dc,
	value _v_x,
...
value camlidl_wxc_idl_wxImageList_Draw_bytecode(value * argv, int argn)
{
  return camlidl_wxc_idl_wxImageList_Draw(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6]);
}

value camlidl_wxc_idl_wxImageList_GetImageCount(
	value _v__obj)
{
  wxImageList _obj; /*in*/
  int _res;
...
value camlidl_wxc_idl_wxImageList_GetSize(
	value _v__obj,
	value _v_index)
{
  wxImageList _obj; /*in*/
...
value camlidl_wxc_idl_wxImageList_Remove(
	value _v__obj,
	value _v_index)
{
  wxImageList _obj; /*in*/
...
value camlidl_wxc_idl_wxImageList_RemoveAll(
	value _v__obj)
{
  wxImageList _obj; /*in*/
  int _res;
...
value camlidl_wxc_idl_wxImageList_Replace(
	value _v__obj,
	value _v_index,
	value _v_bitmap,
	value _v_mask)
...
value camlidl_wxc_idl_wxImageList_ReplaceIcon(
	value _v__obj,
	value _v_index,
	value _v_icon)
{
