...
external selectObject : wxMemoryDC -> wxBitmap -> unit
	= "camlidl_wxc_idl_wxMemoryDC_SelectObject"
...
val startDoc : wxMemoryDC -> string -> bool
val getTextExtent : wxMemoryDC -> string -> voidptr -> voidptr -> voidptr -> voidptr -> wxFont -> unit
val getMultiLineTextExtent : wxMemoryDC -> string -> voidptr -> voidptr -> voidptr -> wxFont -> unit
val drawText : wxMemoryDC -> string -> int -> int -> unit
val drawRotatedText : wxMemoryDC -> string -> int -> int -> float -> unit
val drawLabelBitmap : wxMemoryDC -> string -> wxBitmap -> int -> int -> int -> int -> int -> int -> wxRect
val drawLabel : wxMemoryDC -> string -> int -> int -> int -> int -> int -> int -> unit
  val ptrNULL : wxMemoryDC
