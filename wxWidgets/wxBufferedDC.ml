...
external delete : wxBufferedDC -> unit
	= "camlidl_wxc_wxBufferedDC_Delete"
...
external createByDCAndSize : wxDC -> int -> int -> int -> wxBufferedDC
	= "camlidl_wxc_wxBufferedDC_CreateByDCAndSize"

external createByDCAndBitmap : wxDC -> wxBitmap -> int -> wxBufferedDC
	= "camlidl_wxc_wxBufferedDC_CreateByDCAndBitmap"
...
external null_object : unit -> wxBufferedDC
