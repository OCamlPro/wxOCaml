...
external startDrawingOnTopOfWin : wxScreenDC -> wxWindow -> bool
	= "camlidl_wxc_idl_wxScreenDC_StartDrawingOnTopOfWin"

external startDrawingOnTop : wxScreenDC -> int -> int -> int -> int -> bool
	= "camlidl_wxc_idl_wxScreenDC_StartDrawingOnTop"
...
external endDrawingOnTop : wxScreenDC -> bool
	= "camlidl_wxc_idl_wxScreenDC_EndDrawingOnTop"
...
external delete : wxScreenDC -> unit
	= "camlidl_wxc_idl_wxScreenDC_Delete"
...
external null_object : unit -> wxScreenDC
