...
external setIcon : wxStaticBitmap -> wxIcon -> unit
	= "camlidl_wxc_idl_wxStaticBitmap_SetIcon"
...
external setBitmap : wxStaticBitmap -> wxBitmap -> unit
	= "camlidl_wxc_idl_wxStaticBitmap_SetBitmap"
...
external getIcon : wxStaticBitmap -> wxIcon -> unit
	= "camlidl_wxc_idl_wxStaticBitmap_GetIcon"
...
external getBitmap : wxStaticBitmap -> wxBitmap -> unit
	= "camlidl_wxc_idl_wxStaticBitmap_GetBitmap"
...
external delete : wxStaticBitmap -> unit
	= "camlidl_wxc_idl_wxStaticBitmap_Delete"
...
external null_object : unit -> wxStaticBitmap
