...
let wxGetNumberFromUser message prompt caption _value min max parent x y =
  ...
  let wxres = wxGetNumberFromUser message prompt caption _value min max parent x y  in
