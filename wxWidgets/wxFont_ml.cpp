...
value wxFont_Underlined_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_Underlined_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_Strikethrough_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_Strikethrough_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_Smaller_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_Smaller_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_SetSymbolicSize_c(value self_v, value size_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_SetSymbolicSize_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_SetSymbolicSizeRelativeTo_c(value self_v, value size_v, value base_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_SetSymbolicSizeRelativeTo_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_SetStrikethrough_c(value self_v, value strikethrough_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_SetStrikethrough_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_Scaled_c(value self_v, value x_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_Scaled_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_Scale_c(value self_v, value x_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_Scale_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_MakeUnderlined_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_MakeUnderlined_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_MakeStrikethrough_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_MakeStrikethrough_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_MakeSmaller_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_MakeSmaller_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_MakeLarger_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_MakeLarger_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_MakeItalic_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_MakeItalic_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_MakeBold_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_MakeBold_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_Larger_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_Larger_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_Italic_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_Italic_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_GetWeight_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_GetWeight_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_GetStyle_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_GetStyle_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_GetStrikethrough_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_GetStrikethrough_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_GetFamily_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_GetFamily_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
...
value wxFont_Bold_c(value self_v)
{
  CAMLparam0();
  CAMLlocal1(ret_v);
  caml_failwith("WxWidgets stub wxFont_Bold_c not implemented (version 2.9.0 > current 2.8.12)");
  CAMLreturn(ret_v);
}
}
