...
external yToRow : wxGrid -> int -> int
	= "camlidl_wxc_idl_wxGrid_YToRow"

external yToEdgeOfRow : wxGrid -> int -> int
	= "camlidl_wxc_idl_wxGrid_YToEdgeOfRow"

external xYToCell : wxGrid -> int -> int -> int * int
	= "camlidl_wxc_idl_wxGrid_XYToCell"

external xToEdgeOfCol : wxGrid -> int -> int
	= "camlidl_wxc_idl_wxGrid_XToEdgeOfCol"

external xToCol : wxGrid -> int -> int
	= "camlidl_wxc_idl_wxGrid_XToCol"
...
external stringToLines : wxGrid -> wxString -> voidptr -> int
	= "camlidl_wxc_idl_wxGrid_StringToLines"
...
external showCellEditControl : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_ShowCellEditControl"
...
external setTable : wxGrid -> wxGridTableBase -> bool -> int -> bool
	= "camlidl_wxc_idl_wxGrid_SetTable"
...
external setSelectionMode : wxGrid -> int -> unit
	= "camlidl_wxc_idl_wxGrid_SetSelectionMode"

external setSelectionForeground : wxGrid -> wxColour -> unit
	= "camlidl_wxc_idl_wxGrid_SetSelectionForeground"

external setSelectionBackground : wxGrid -> wxColour -> unit
	= "camlidl_wxc_idl_wxGrid_SetSelectionBackground"
...
external setMargins : wxGrid -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_SetMargins"

external setLabelTextColour : wxGrid -> wxColour -> unit
	= "camlidl_wxc_idl_wxGrid_SetLabelTextColour"

external setLabelFont : wxGrid -> wxFont -> unit
	= "camlidl_wxc_idl_wxGrid_SetLabelFont"

external setLabelBackgroundColour : wxGrid -> wxColour -> unit
	= "camlidl_wxc_idl_wxGrid_SetLabelBackgroundColour"
...
external setGridLineColour : wxGrid -> wxColour -> unit
	= "camlidl_wxc_idl_wxGrid_SetGridLineColour"

external setGridCursor : wxGrid -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_SetGridCursor"
...
external selectRow : wxGrid -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_SelectRow"

external selectCol : wxGrid -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_SelectCol"

external selectBlock : wxGrid -> int -> int -> int -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_SelectBlock_bytecode" "camlidl_wxc_idl_wxGrid_SelectBlock"

external selectAll : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_SelectAll"
...
external saveEditControlValue : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_SaveEditControlValue"
...
external registerDataType : wxGrid -> wxString -> wxGridCellRenderer -> wxGridCellEditor -> unit
	= "camlidl_wxc_idl_wxGrid_RegisterDataType"
...
external processTableMessage : wxGrid -> wxEvent -> bool
	= "camlidl_wxc_idl_wxGrid_ProcessTableMessage"
...
external movePageUp : wxGrid -> bool
	= "camlidl_wxc_idl_wxGrid_MovePageUp"

external movePageDown : wxGrid -> bool
	= "camlidl_wxc_idl_wxGrid_MovePageDown"

external moveCursorUpBlock : wxGrid -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_MoveCursorUpBlock"

external moveCursorUp : wxGrid -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_MoveCursorUp"

external moveCursorRightBlock : wxGrid -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_MoveCursorRightBlock"

external moveCursorRight : wxGrid -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_MoveCursorRight"

external moveCursorLeftBlock : wxGrid -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_MoveCursorLeftBlock"

external moveCursorLeft : wxGrid -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_MoveCursorLeft"

external moveCursorDownBlock : wxGrid -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_MoveCursorDownBlock"

external moveCursorDown : wxGrid -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_MoveCursorDown"
...
external makeCellVisible : wxGrid -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_MakeCellVisible"
...
external isVisible : wxGrid -> int -> int -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_IsVisible"
...
external gridLinesEnabled : wxGrid -> int
	= "camlidl_wxc_idl_wxGrid_GridLinesEnabled"
...
external getTextBoxSize : wxGrid -> wxDC -> int -> string option -> int * int
	= "camlidl_wxc_idl_wxGrid_GetTextBoxSize"
...
external getTable : wxGrid -> wxGridTableBase
	= "camlidl_wxc_idl_wxGrid_GetTable"
...
external getRowSize : wxGrid -> int -> int
	= "camlidl_wxc_idl_wxGrid_GetRowSize"

external getRowLabelValue : wxGrid -> int -> wxString
	= "camlidl_wxc_idl_wxGrid_GetRowLabelValue"

external getRowLabelSize : wxGrid -> int
	= "camlidl_wxc_idl_wxGrid_GetRowLabelSize"

external getRowLabelAlignment : wxGrid -> int * int
	= "camlidl_wxc_idl_wxGrid_GetRowLabelAlignment"
...
external getNumberRows : wxGrid -> int
	= "camlidl_wxc_idl_wxGrid_GetNumberRows"

external getNumberCols : wxGrid -> int
	= "camlidl_wxc_idl_wxGrid_GetNumberCols"
...
external getLabelTextColour : wxGrid -> wxColour -> unit
	= "camlidl_wxc_idl_wxGrid_GetLabelTextColour"

external getLabelFont : wxGrid -> wxFont -> unit
	= "camlidl_wxc_idl_wxGrid_GetLabelFont"
...
external getLabelBackgroundColour : wxGrid -> wxColour -> unit
	= "camlidl_wxc_idl_wxGrid_GetLabelBackgroundColour"
...
external getGridLineColour : wxGrid -> wxColour -> unit
	= "camlidl_wxc_idl_wxGrid_GetGridLineColour"

external getGridCursorRow : wxGrid -> int
	= "camlidl_wxc_idl_wxGrid_GetGridCursorRow"

external getGridCursorCol : wxGrid -> int
	= "camlidl_wxc_idl_wxGrid_GetGridCursorCol"
...
external getColSize : wxGrid -> int -> int
	= "camlidl_wxc_idl_wxGrid_GetColSize"

external getColLabelValue : wxGrid -> int -> wxString
	= "camlidl_wxc_idl_wxGrid_GetColLabelValue"

external getColLabelSize : wxGrid -> int
	= "camlidl_wxc_idl_wxGrid_GetColLabelSize"

external getColLabelAlignment : wxGrid -> int * int
	= "camlidl_wxc_idl_wxGrid_GetColLabelAlignment"
...
external getBatchCount : wxGrid -> int
	= "camlidl_wxc_idl_wxGrid_GetBatchCount"
...
external endBatch : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_EndBatch"
...
external enableGridLines : wxGrid -> bool -> unit
	= "camlidl_wxc_idl_wxGrid_EnableGridLines"

external enableEditing : wxGrid -> int -> unit
	= "camlidl_wxc_idl_wxGrid_EnableEditing"

external enableDragRowSize : wxGrid -> bool -> unit
	= "camlidl_wxc_idl_wxGrid_EnableDragRowSize"

external enableDragGridSize : wxGrid -> bool -> unit
	= "camlidl_wxc_idl_wxGrid_EnableDragGridSize"

external enableDragColSize : wxGrid -> bool -> unit
	= "camlidl_wxc_idl_wxGrid_EnableDragColSize"

external enableCellEditControl : wxGrid -> bool -> unit
	= "camlidl_wxc_idl_wxGrid_EnableCellEditControl"
...
external drawTextRectangle : wxGrid -> wxDC -> wxString -> int -> int -> int -> int -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_DrawTextRectangle_bytecode" "camlidl_wxc_idl_wxGrid_DrawTextRectangle"

external drawRowLabels : wxGrid -> wxDC -> unit
	= "camlidl_wxc_idl_wxGrid_DrawRowLabels"

external drawRowLabel : wxGrid -> wxDC -> int -> unit
	= "camlidl_wxc_idl_wxGrid_DrawRowLabel"

external drawGridSpace : wxGrid -> wxDC -> unit
	= "camlidl_wxc_idl_wxGrid_DrawGridSpace"

external drawColLabels : wxGrid -> wxDC -> unit
	= "camlidl_wxc_idl_wxGrid_DrawColLabels"

external drawColLabel : wxGrid -> wxDC -> int -> unit
	= "camlidl_wxc_idl_wxGrid_DrawColLabel"

external drawCellHighlight : wxGrid -> wxDC -> wxGridCellAttr -> unit
	= "camlidl_wxc_idl_wxGrid_DrawCellHighlight"

external drawCellBorder : wxGrid -> wxDC -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_DrawCellBorder"

external drawCell : wxGrid -> wxDC -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_DrawCell"

external drawAllGridLines : wxGrid -> wxDC -> wxRegion -> unit
	= "camlidl_wxc_idl_wxGrid_DrawAllGridLines"
...
external disableDragRowSize : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_DisableDragRowSize"

external disableDragGridSize : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_DisableDragGridSize"

external disableDragColSize : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_DisableDragColSize"

external disableCellEditControl : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_DisableCellEditControl"
...
external deleteRows : wxGrid -> int -> int -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_DeleteRows"
...
external connect : wxGrid -> int -> int -> (wxEvent -> unit) -> unit
...
external clearSelection : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_ClearSelection"

external clearGrid : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_ClearGrid"
...
external blockToDeviceRect : wxGrid -> int -> int -> int -> int -> wxRect
	= "camlidl_wxc_idl_wxGrid_BlockToDeviceRect"

external beginBatch : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_BeginBatch"

external autoSizeRows : wxGrid -> int -> unit
	= "camlidl_wxc_idl_wxGrid_AutoSizeRows"

external autoSizeRow : wxGrid -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_AutoSizeRow"

external autoSizeColumns : wxGrid -> int -> unit
	= "camlidl_wxc_idl_wxGrid_AutoSizeColumns"

external autoSizeColumn : wxGrid -> int -> int -> unit
	= "camlidl_wxc_idl_wxGrid_AutoSizeColumn"

external autoSize : wxGrid -> unit
	= "camlidl_wxc_idl_wxGrid_AutoSize"

external appendRows : wxGrid -> int -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_AppendRows"

external appendCols : wxGrid -> int -> bool -> bool
	= "camlidl_wxc_idl_wxGrid_AppendCols"
...
val stringToLines : wxGrid -> string -> voidptr -> int
val setToolTip : wxGrid -> string -> unit
val setRowLabelValue : wxGrid -> int -> string -> unit
val setName : wxGrid -> string -> unit
val setLabel : wxGrid -> string -> unit
val setColLabelValue : wxGrid -> int -> string -> unit
val setColFormatCustom : wxGrid -> int -> string -> unit
val setCellValue : wxGrid -> int -> int -> string -> unit
val registerDataType : wxGrid -> string -> wxGridCellRenderer -> wxGridCellEditor -> unit
val getToolTip : wxGrid -> string
val getTextExtent : wxGrid -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getRowLabelValue : wxGrid -> int -> string
val getName : wxGrid -> string
val getLabel : wxGrid -> string
val getDefaultRendererForType : wxGrid -> string -> wxGridCellRenderer
val getDefaultEditorForType : wxGrid -> string -> wxGridCellEditor
val getColLabelValue : wxGrid -> int -> string
val getCellValue : wxGrid -> int -> int -> string
val findWindow : wxGrid -> string -> wxWindow
val drawTextRectangle : wxGrid -> wxDC -> string -> int -> int -> int -> int -> int -> int -> unit
  val ptrNULL : wxGrid
