...
external connect : wxSplashScreen -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
val setStatusText : wxSplashScreen -> string -> int -> unit
val setName : wxSplashScreen -> string -> unit
val setLabel : wxSplashScreen -> string -> unit
val getToolTip : wxSplashScreen -> string
val getTitle : wxSplashScreen -> string
val getTextExtent : wxSplashScreen -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxSplashScreen -> string
val getLabel : wxSplashScreen -> string
val findWindow : wxSplashScreen -> string -> wxWindow
  val ptrNULL : wxSplashScreen
