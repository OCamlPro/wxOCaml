...
external connect : wxGenericDirCtrl -> int -> ('a WxEVT.t) -> ('a -> unit) -> unit
...
val setToolTip : wxGenericDirCtrl -> string -> unit
val setName : wxGenericDirCtrl -> string -> unit
val setLabel : wxGenericDirCtrl -> string -> unit
val getToolTip : wxGenericDirCtrl -> string
val getTextExtent : wxGenericDirCtrl -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxGenericDirCtrl -> string
val getLabel : wxGenericDirCtrl -> string
val findWindow : wxGenericDirCtrl -> string -> wxWindow
  val ptrNULL : wxGenericDirCtrl
