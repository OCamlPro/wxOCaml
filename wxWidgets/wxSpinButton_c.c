...
void camlidl_ml2c_wxc_idl_wxSpinButton(value _v1, wxSpinButton * _c2, camlidl_ctx _ctx)
{
  *_c2 = *((wxSpinButton *) Bp_val(_v1));
}

value camlidl_c2ml_wxc_idl_wxSpinButton(wxSpinButton * _c2, camlidl_ctx _ctx)
{
value _v1;
...
value camlidl_wxc_idl_wxSpinButton_Create(
	value _v__prt,
	value _v__id,
	value _v__lft,
	value _v__top,
...
value camlidl_wxc_idl_wxSpinButton_Create_bytecode(value * argv, int argn)
{
  return camlidl_wxc_idl_wxSpinButton_Create(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6]);
}

value camlidl_wxc_idl_wxSpinButton_GetMax(
	value _v__obj)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_wxc_idl_wxSpinButton(_v__obj, &_obj, _ctx);
...
value camlidl_wxc_idl_wxSpinButton_GetMin(
	value _v__obj)
{
  wxSpinButton _obj; /*in*/
  int _res;
...
value camlidl_wxc_idl_wxSpinButton_GetValue(
	value _v__obj)
{
  wxSpinButton _obj; /*in*/
  int _res;
...
value camlidl_wxc_idl_wxSpinButton_SetRange(
	value _v__obj,
	value _v_minVal,
	value _v_maxVal)
{
...
value camlidl_wxc_idl_wxSpinButton_SetValue(
	value _v__obj,
	value _v__val)
{
  wxSpinButton _obj; /*in*/
