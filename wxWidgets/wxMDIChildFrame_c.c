...
void camlidl_ml2c_wxc_idl_wxMDIChildFrame(value _v1, wxMDIChildFrame * _c2, camlidl_ctx _ctx)
{
  *_c2 = *((wxMDIChildFrame *) Bp_val(_v1));
}

value camlidl_c2ml_wxc_idl_wxMDIChildFrame(wxMDIChildFrame * _c2, camlidl_ctx _ctx)
{
value _v1;
...
value camlidl_wxc_idl_wxMDIChildFrame_Activate(
	value _v__obj)
{
  wxMDIChildFrame _obj; /*in*/
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_wxc_idl_wxMDIChildFrame(_v__obj, &_obj, _ctx);
  wxMDIChildFrame_Activate(_obj);
  camlidl_free(_ctx);
  return Val_unit;
}

value camlidl_wxc_idl_wxMDIChildFrame_Create(
	value _v__prt,
	value _v__id,
	value _v__txt,
	value _v__lft,
...
value camlidl_wxc_idl_wxMDIChildFrame_Create_bytecode(value * argv, int argn)
{
  return camlidl_wxc_idl_wxMDIChildFrame_Create(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7]);
}
