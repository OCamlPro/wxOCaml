...
external wxnew : wxWindow -> int -> int -> int -> int -> int -> int -> string option -> int -> wxCheckListBox
...
external isChecked : wxCheckListBox -> int -> bool
	= "camlidl_wxc_idl_wxCheckListBox_IsChecked"
...
external delete : wxCheckListBox -> unit
	= "camlidl_wxc_idl_wxCheckListBox_Delete"
...
external connect : wxCheckListBox -> int -> int -> (wxEvent -> unit) -> unit
...
external check : wxCheckListBox -> int -> bool -> unit
	= "camlidl_wxc_idl_wxCheckListBox_Check"
...
external null_object : unit -> wxCheckListBox
