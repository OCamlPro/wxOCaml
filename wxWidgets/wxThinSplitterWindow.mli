...
external connect : wxThinSplitterWindow -> int -> int -> (wxEvent -> unit) -> unit
...
val setToolTip : wxThinSplitterWindow -> string -> unit
val setName : wxThinSplitterWindow -> string -> unit
val setLabel : wxThinSplitterWindow -> string -> unit
val getToolTip : wxThinSplitterWindow -> string
val getTextExtent : wxThinSplitterWindow -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxThinSplitterWindow -> string
val getLabel : wxThinSplitterWindow -> string
val findWindow : wxThinSplitterWindow -> string -> wxWindow
  val ptrNULL : wxThinSplitterWindow
