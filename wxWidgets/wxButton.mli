...
external connect : wxButton -> int -> int -> (wxEvent -> unit) -> unit
...
val wxnew : wxWindow -> int -> string -> int -> int -> int -> int -> int -> wxButton
val setToolTip : wxButton -> string -> unit
val setName : wxButton -> string -> unit
val setLabel : wxButton -> string -> unit
val getToolTip : wxButton -> string
val getTextExtent : wxButton -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxButton -> string
val getLabel : wxButton -> string
val findWindow : wxButton -> string -> wxWindow
  val ptrNULL : wxButton
