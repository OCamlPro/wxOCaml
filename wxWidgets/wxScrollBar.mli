...
external setThumbPosition : wxScrollBar -> int -> unit
	= "camlidl_wxc_idl_wxScrollBar_SetThumbPosition"
...
external setScrollbar : wxScrollBar -> int -> int -> int -> int -> bool -> unit
	= "camlidl_wxc_idl_wxScrollBar_SetScrollbar_bytecode" "camlidl_wxc_idl_wxScrollBar_SetScrollbar"
...
external getThumbSize : wxScrollBar -> int
	= "camlidl_wxc_idl_wxScrollBar_GetThumbSize"

external getThumbPosition : wxScrollBar -> int
	= "camlidl_wxc_idl_wxScrollBar_GetThumbPosition"
...
external getRange : wxScrollBar -> int
	= "camlidl_wxc_idl_wxScrollBar_GetRange"
...
external getPageSize : wxScrollBar -> int
	= "camlidl_wxc_idl_wxScrollBar_GetPageSize"
...
val setToolTip : wxScrollBar -> string -> unit
val setName : wxScrollBar -> string -> unit
val setLabel : wxScrollBar -> string -> unit
val getToolTip : wxScrollBar -> string
val getTextExtent : wxScrollBar -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxScrollBar -> string
val getLabel : wxScrollBar -> string
val findWindow : wxScrollBar -> string -> wxWindow
  val ptrNULL : wxScrollBar
