...
external layoutWindow : wxLayoutAlgorithm -> wxFrame -> voidptr -> bool
	= "camlidl_wxc_wxLayoutAlgorithm_LayoutWindow"

external layoutMDIFrame : wxLayoutAlgorithm -> wxFrame -> int -> int -> int -> int -> int -> bool
	= "camlidl_wxc_wxLayoutAlgorithm_LayoutMDIFrame_bytecode" "camlidl_wxc_wxLayoutAlgorithm_LayoutMDIFrame"

external layoutFrame : wxLayoutAlgorithm -> wxFrame -> voidptr -> bool
	= "camlidl_wxc_wxLayoutAlgorithm_LayoutFrame"
...
external delete : wxLayoutAlgorithm -> unit
	= "camlidl_wxc_wxLayoutAlgorithm_Delete"

  val ptrNULL : wxLayoutAlgorithm
