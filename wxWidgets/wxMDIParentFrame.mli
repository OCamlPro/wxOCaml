...
val setTitle : wxMDIParentFrame -> string -> unit
val setStatusText : wxMDIParentFrame -> string -> int -> unit
val setName : wxMDIParentFrame -> string -> unit
val setLabel : wxMDIParentFrame -> string -> unit
val getToolTip : wxMDIParentFrame -> string
val getTitle : wxMDIParentFrame -> string
val getTextExtent : wxMDIParentFrame -> string -> int option -> int option -> int option -> int option -> wxFont -> unit
val getName : wxMDIParentFrame -> string
val getLabel : wxMDIParentFrame -> string
val findWindow : wxMDIParentFrame -> string -> wxWindow
  val ptrNULL : wxMDIParentFrame
